...
// import { getWorkspaceModuleConfig, updateWorkspaceConfigBySlug } from '@/lib/api/workspace';
...
//   const { data: workspaceConfig, error } = await getWorkspaceModuleConfig(context.params.slug, 'route');
...
//   const { data: updatedWorkspaceConfig, error } = await updateWorkspaceConfigBySlug(
//     context.params.slug,
//     {
//       changelog_enabled: changelogEnabled,
//       changelog_preview_style: changelogPreviewStyle,
