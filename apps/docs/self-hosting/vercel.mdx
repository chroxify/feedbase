...
description: 'How to self-host Luminar on Vercel'
---
...
<Accordion title="Using the Supabase CLI (Recommended)">
    ...
    <Steps>
        <Step title="Clone the Luminar repository">
            ```bash
...
<Accordion title="Manually using the SQL Editor">
    <Steps>
        ...
        <Step title="Run the migrations">
            Copy and paste all the contents of each file in the [`supabase/migrations`](https://github.com/chroxify/luminar/tree/main/supabase/migrations) folder of the Luminar repository into the SQL editor and run them.
        </Step>
...
You can find a list of all environment variables and where to find them [here](https://github.com/chroxify/luminar/blob/main/.env.example).

## Deploy to Vercel

Finally, you can deploy your Luminar instance to Vercel by following the instructions [here](https://luminar.so/deploy-vercel).
